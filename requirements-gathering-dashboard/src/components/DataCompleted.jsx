...
const DataCompleted = () => {
    ...
    const columns = [
        ...
        { field: 'opening', headerName: 'Opening', headerAlign: 'center', flex: 1 },
        {
            ...
            .then(result => {
                ...
                for (let i = 0; i < result.data.length; i++) {
                    temp.push({
                        ...
                        address: result.data[i].lastname,
                        opening: result.data[i].description,
                        rating: result.data[i].priority,
